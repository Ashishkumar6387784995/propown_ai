    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <a href="index.html" class="navbar-brand mx-auto mx-lg-0">
                <img src="images/propownai.png" alt="">
            </a>

            <div class="d-flex align-items-center d-lg-none">
                <a href="" class="navbar-icon">Sign In</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-lg-5">
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_3">Mortgage Calculator</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link click-scroll" href="#section_3">Property</a>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="#">Home ownership</a></li>
                            <li><a class="dropdown-item" href="#">House tax savings</a></li>
                            <li><a class="dropdown-item" href="#">House repairs and improvement</a></li>
                            <li><a class="dropdown-item" href="#">Solar panel installations</a></li>
...
@if (Route::has('login'))
    <nav class="flex items-center justify-end gap-4">
        @auth
            <div class="dropdown d-lg-flex align-items-center d-none ms-auto">
                <a class="dropdown-toggle nav-link custom-btn btn" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        @else
            <div class="d-lg-flex align-items-center d-none ms-auto">
                <a href="{{ route('login') }}" class="navbar-icon2">Sign In</a>

                @if (Route::has('register'))
                    <a class="custom-btn btn" href="{{ route('register') }}">
                        Sign Up
                    </a>
                @endif
            </div>
...
@endif
    ...
    <main>
        ...
        <section class="hero d-flex justify-content-center align-items-center" id="section_1">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12 od-2">
                        <div class="hero-text">
                            ...
                            <h2 class="mb-4 text-center">Experience the home ownership with propown.ai copilot

                            </h2>
                            <p class="text-white p_1">Experience a new era of real estate with our cutting-edge propown.ai
                                platform. We combine
                                technology and financial innovation to simplify property buying, selling, investing, and
                                financing. </p>
                            <p class="mb-4"><a class="custom-btn btn custom-link" href="#section_2">Let's begin</a></p>
                        </div>
                    </div>

                    <div class="col-lg-5 col-12 od-1 position-relative">
                        <!-- <div class="hero-image-wrap"></div> -->
                        <img src="images/per-1.png" class="hero-image img-fluid" alt="">
                    </div>
        ...
        <section class="howsave">
            <div class="container">
                <div class="heading-1 text-center">
                    <h1>How You Can <span> Save </span></h1>
                </div>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="innercard">
                            <img src="images/maintenace.png" alt="" class="m-img">
                            <h6>Maximize Your Property Tax Savings</h6>
                            <p>Did you know you may qualify for property tax exemptions that can significantly lower
                                your tax bill? From primary residence discounts to senior citizen benefits, these
                                exemptions reduce your property's taxable value. Just answer a few simple questions—our
                                team will handle the rest, from filing to ongoing management—helping you save more with
                                less hassle.
                            </p>
                    ...
                    <div class="col-lg-6 ">
                        <div class="innercard right-align">
                            <img src="images/padlock.png" alt="" class="m-img">
                            <h6>Property Tax Exemptions</h6>
                            <p>Various property tax exemptions—such as those for primary residences, seniors, and
                                more—can lower your property’s assessed value, reducing your overall tax burden. Simply
                                provide a few details, and we’ll take care of filing and managing your exemptions to
                                help you save more effortlessly.</p>
                            <a href="#">Learn more <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="row round2">
                    <div class="col-lg-6">
                        <div class="innercard">
                            <img src="images/home-insurance.png" alt="" class="m-img">
                            <h6>Insurance Rate Monitoring</h6>
                            <p>We track your insurance rates and coverage to make sure you're not paying more than you
                                should. Just answer a few quick questions, and we'll review and compare policies to find
                                better deals. Our ongoing monitoring ensures you always have the right coverage at the
                    ...
                    <div class="col-lg-6">
                        <div class="innercard right-align">
                            <img src="images/bill.png" alt="" class="m-img">
                            <h6>Bill Reduction Services</h6>
                            <p>Tired of high internet and phone bills? Simply upload your statement, and our savings
                                specialists will negotiate directly with your provider to lower your monthly costs. We
                                continuously monitor and compare your bills to ensure you’re always getting the best
                                value.
                            </p>
                            <a href="#">Learn more <i class="fa-solid fa-arrow-right"></i></a>
                        </div>
        ...
        <section class="m_howsave">
            <div class="container">
                <div class="row">
                    <div class="saveslide owl-carousel owl-theme">
                        <div class="innercard">
                            <img src="images/maintenace.png" alt="" class="m-img">
                            <h6>Maximize Your Property Tax Savings</h6>
                            <p>Did you know you may qualify for property tax exemptions that can significantly lower
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="fqa-card">
                            ...
                            <div class="f_card">
                                <img src="images/maintenace.png" alt="">
                                <h5>How much do you pay?</h5>
                            </div>
                            <p>Our services are completely free for anyone who owns the property or is looking for a property</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="fqa-card">
                            ...
                            <div class="f_card">
                                <img src="images/maintenace.png" alt="">
                                <h5>What will you experience?</h5>
                            </div>
                            <p>You are going to a AI Copilot who will analyze your needs and recommends to the best next course of action</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="fqa-card">
                            ...
                            <div class="f_card">
                                <img src="images/maintenace.png" alt="">
                                <h5>How do we match?</h5>
                            </div>
                            <p>We use AI/ML models to match your needs with most best negotiated vendors.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="fqa-card">
                            ...
                            <div class="f_card">
                                <img src="images/maintenace.png" alt="">
                                <h5>How can Vendors benefitted?</h5>
                            </div>
                            <p>We use AI/ML models to match the needs of consumers with most negotiated vendors.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                        <div class="about-thumb">
                            ...
                            <p>This one-page HTML portfolio is provided by <a href="https://templatemo.com"
                                ...
                                libraries. Image credits go to <a href="https://unsplash.com"
                                    target="_blank">Unsplash</a> and <a href="https://freepik.com"
                                    target="_blank">FreePik</a> for images used in this page.</p>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-12">
                    <div class="copyright-text-wrap">
                        <p class="mb-0">
                            <span class="copyright-text">Copyright © 2025 <a href="#">propown.ai</a> Company. All
